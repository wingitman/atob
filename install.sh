...
main() {
  ...
  echo ""
  echo "  List every converter:"
  echo "    atob list"
  echo ""
  echo "  Pipe text through a converter:"
  echo "    echo 'hello world' | atob base64-encode"
  echo "    echo 'aGVsbG8gd29ybGQ=' | atob base64-decode"
  echo "    echo '{\"a\":1}' | atob json-yaml"
  echo "    echo 'hello_world' | atob case-camel"
  echo ""
  echo "  File-based conversions:"
  echo "    atob csv-xlsx input.csv output.xlsx"
  echo "    atob xlsx-csv input.xlsx output.csv"
  echo ""
